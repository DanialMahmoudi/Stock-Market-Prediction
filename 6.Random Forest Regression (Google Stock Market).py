...
#Importing The dataset & Training The Random Forest Regression with rbf Kernel & Evaluating The Model
...
print("Random Forest Regression model's accuracy is : ")
print(acc)
...
###################
'''Note that applying Random Forest Regression model to the mentioned dataset will lead to a 
