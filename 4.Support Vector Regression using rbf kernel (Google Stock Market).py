...
#Importing The dataset & Training The Support Vector Regression with rbf Kernel & Evaluating The Model
...
print("Support Vector Regression model's accuracy using rbf Kernel is : ")
print(acc)
...
###################
'''Note that applying Support Vector Regression model with rbf kernel to the mentioned dataset will 
lead to a considerable overfitting since the evaluation of a new alternative dataset will be 
