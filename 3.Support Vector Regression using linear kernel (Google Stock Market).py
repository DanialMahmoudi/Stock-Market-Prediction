...
#Importing The dataset & Training The Support Vector Regression with Linear Kernel & Evaluating The Model
...
print("Support Vector Regression model's accuracy using Linear Kernel is : ")
print(acc)
